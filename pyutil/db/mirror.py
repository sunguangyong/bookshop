...
class mirror:
    ...
    def Find(self, tabName, fieldList=[], indexMap={}, limit=(), orderby=((),"asc"), out=dict):
        ...
        #print "::::mirror, tabName:", tabName
        url = self.__url(tabName, indexMap, "GET")

        #print '::::mirror request url::::', url 
        result = http_util.Request(url)
        
        #print '::::mirror response result :::: ', result
    ...
    def Update(self, tabName, dataMap, indexMap):
        ...
        print "Update, uri=",url, ",tabName=", tabName, ",data:", json.dumps(dataMap), "method:","PUT"
    ...
    def Insert(self, tabName, dataMap):
        ...
        print "Insert, url:", url, tabName, dataMap
